declare module 'fastly:backend' {
  interface BackendConfiguration {
     ...
     * When pooling is enabled, if Session 1 opens a connection to this backend it will be left open, and can be re-used by Session 2.
     * This can help improve backend latency, by removing the need for the initial network / TLS handshake(s).
     * By default, pooling is enabled
     * @defaultValue false
     */
    dontPool?: boolean;
    /**
